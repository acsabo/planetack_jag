...
;	----------------------------------------------------------------------------------------------------------
;	NOTE: The First and Last Objects in this list must always be "Active".
;	----------------------------------------------------------------------------------------------------------
...
; Object Template
;			value			possible values							description															label to access
...
;	dc.w	16,0			; 										; Put sprite this many pixels from left side of screen.				;   R_sprite_x
...
;	dc.l	0				;										; Width of collision box from centre in pixels						;   R_sprite_hbox
;	dc.l	0				;										; Height of collision box from centre in pixels						;   R_sprite_vbox
;	dc.l	SPRITENAME		;										; Place in memory where the sprite lives: label from RAPAPP.S		;   R_sprite_gfxbase
;	dc.l	16				; 1,  2,  4,  8,  16,  24				; Sprite graphics type: 1,2,4,8,16 or 24 bit						;   R_sprite_bdepth
;	dc.l	is_RGB			; is_RGB			is_cry				; Sprite graphics type. RGB or Atari's CRY format.					;   R_sprite_cryrgb
;	dc.l	is_opaque		; is_trans			is_opaque			; Trans for see-through background, opaque for solid background		;   R_sprite_trans
...
;																	; *2 for 16bit
;																	; *4 for 24bit
;	dc.l	0				;										; Number of screen updates (VB) before the animation advances		;   R_sprite_animspd
